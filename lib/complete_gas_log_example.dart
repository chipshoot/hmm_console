...
class GasLogAppSetup {
  ...
  static Future<void> demonstrateUsage() async {
    ...
    print('🚀 Starting Gas Log demonstration...');
    ...
    print('💾 Saved gas logs with IDs: $savedId1, $savedId2');
    ...
    print('📋 Retrieved ${allLogs.length} gas logs from database');
    ...
    for (var log in allLogs) {
      print('🚗 ${log.odometer} miles - ${log.gas} gallons - \$${log.price}');
    }
    ...
    print('🔍 Found specific log: ${specificLog.odometer} miles');
    ...
    print('✏️ Updated gas log comment');
    ...
    print('📅 Current month has ${currentMonthLogs.length} gas logs');
                  ...
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${log.gas.toStringAsFixed(1)} gal • \$${log.price.toStringAsFixed(2)}',
                        ),
                        // Secondary information: distance and date
                        Text(
                          '${log.distance.toStringAsFixed(1)} miles • ${log.date.toString().split(' ')[0]}',
                        ),
