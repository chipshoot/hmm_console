...
final class $$NotesTableReferences
  ...
  _attachmentsRefsTable(_$HmmDatabase db) => MultiTypedResultKey.fromTable(
    db.attachments,
...
final class $$AttachmentsTableReferences
    extends BaseReferences<_$HmmDatabase, $AttachmentsTable, Attachment> {
...
class $$AttachmentsTableFilterComposer
    extends Composer<_$HmmDatabase, $AttachmentsTable> {
  $$AttachmentsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$AttachmentsTableTableManager
    extends
        ...
        > {
  $$AttachmentsTableTableManager(_$HmmDatabase db, $AttachmentsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
