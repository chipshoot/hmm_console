...
class LocalAutomobileRepository implements IAutomobileRepository {
  ...
  Future<void> deactivateAutomobile(int id) async {
    ...
    final deactivated = Automobile(
      ...
      registrationJurisdiction: current.registrationJurisdiction,
      registrationIssuedDate: current.registrationIssuedDate,
  ...
  Automobile? _deserialize(HmmNote note) {
    ...
    try {
      ...
      return Automobile(
        ...
        registrationIssuedDate: d['registrationIssuedDate'] is String
